...
| `storage.ts`           | `listVolumes`, `getVolumeSpace`, `watchVolumeSpace`/`unwatchVolumeSpace`, `ejectVolume`, `getBusyVolumeIds` (bootstrap for the eject-busy gate), `onVolumeContextAction`, `checkFullDiskAccess`, `getMacosMajorVersion`, `openPrivacySettings`, `openSystemSettingsUrl`                                               |
