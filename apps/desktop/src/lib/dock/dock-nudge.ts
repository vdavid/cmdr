 ...
 *
 * The offer is once-ever, and the ledger is stamped the moment the toast goes
 * UP: a crash between raising it and answering it costs one offer, where
 * stamping on the answer would risk repeating the toast forever.
 *
...
/**
 * Raises the offer and stamps the nudge ledger on the way up. The stamp both
 * closes this offer for good and starts the cooldown the next one obeys.
 *
