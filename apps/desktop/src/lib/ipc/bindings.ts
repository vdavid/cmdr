...
export const commands = {
	...
	listDirectoryStart: (path: string, includeHidden: boolean, sortBy: SortColumn, sortOrder: SortOrder, directorySortMode: 
...
"alwaysByName" | null) => typedError<ListingStartResult, IpcError>(__TAURI_INVOKE("list_directory_start", { path, includeHidden, sortBy, sortOrder, directorySortMode })),
	/**
	 *  Returns immediately; reads in background.
	 *  Emits listing-progress, listing-complete, listing-error, listing-cancelled.
	 */
	listDirectoryStartStreaming: (volumeId: string, path: string, includeHidden: boolean, sortBy: SortColumn, sortOrder: SortOrder, directorySortMode: 
// Directories sort by the same column as files (using recursive_size for Size column).
"likeFiles" | 
// Directories always sort by name, regardless of the active sort column.
"alwaysByName" | null, listingId: string) => typedError<StreamingListingStartResult, string>(__TAURI_INVOKE("list_directory_start_streaming", { volumeId, path, includeHidden, sortBy, sortOrder, directorySortMode, listingId })),
	...
	getFileRange: (listingId: string, start: number, count: number, includeHidden: boolean) => typedError<FileEntry[], string>(__TAURI_INVOKE("get_file_range", { listingId, start, count, includeHidden })),
	getFileAt: (listingId: string, index: number, includeHidden: boolean) => typedError<{
	name: string,
	path: string,
	isDirectory: boolean,
	isSymlink: boolean,
...
} | null, string>(__TAURI_INVOKE("get_file_at", { listingId, index, includeHidden })),
	/**
	 ...
	 */
	getFilesAtIndices: (listingId: string, selectedIndices: number[], includeHidden: boolean) => typedError<FileEntry[], string>(__TAURI_INVOKE("get_files_at_indices", { listingId, selectedIndices, includeHidden })),
	/**
	 ...
	 */
	getPathsAtIndices: (listingId: string, selectedIndices: number[], includeHidden: boolean, hasParent: boolean) => typedError<string[], string>(__TAURI_INVOKE("get_paths_at_indices", { listingId, selectedIndices, includeHidden, hasParent })),
	getTotalCount: (listingId: string, includeHidden: boolean) => typedError<number, string>(__TAURI_INVOKE("get_total_count", { listingId, includeHidden })),
	/**
	 ...
	 */
	getBriefColumnTextWidths: (listingId: string, itemsPerColumn: number, hasParent: boolean, fontId: string, includeHidden: boolean) => typedError<number[], IpcError>(__TAURI_INVOKE("get_brief_column_text_widths", { listingId, itemsPerColumn, hasParent, fontId, includeHidden })),
	findFileIndex: (listingId: string, name: string, includeHidden: boolean) => typedError<number | null, string>(__TAURI_INVOKE("find_file_index", { listingId, name, includeHidden })),
	findFileIndices: (listingId: string, names: string[], includeHidden: boolean) => typedError<{ [key in string]: number }, string>(__TAURI_INVOKE("find_file_indices", { listingId, names, includeHidden })),
	/**
	 ...
	 */
	findFirstFuzzyMatch: (listingId: string, query: string, includeHidden: boolean) => typedError<number | null, IpcError>(__TAURI_INVOKE("find_first_fuzzy_match", { listingId, query, includeHidden })),
	resortListing: (listingId: string, sortBy: SortColumn, sortOrder: SortOrder, directorySortMode: 
// Directories sort by the same column as files (using recursive_size for Size column).
"likeFiles" | 
// Directories always sort by name, regardless of the active sort column.
"alwaysByName" | null, cursorFilename: string | null, includeHidden: boolean, selectedIndices: number[] | null, allSelected: boolean | null) => typedError<ResortResult, string>(__TAURI_INVOKE("resort_listing", { listingId, sortBy, sortOrder, directorySortMode, cursorFilename, includeHidden, selectedIndices, allSelected })),
	 ...
	 */
	pathExists: (volumeId: string | null, path: string) => __TAURI_INVOKE<TimedOut<boolean>>("path_exists", { volumeId, path }),
	/**
	...
	createDirectory: (volumeId: string | null, parentPath: string, name: string) => typedError<string, IpcError>(__TAURI_INVOKE("create_directory", { volumeId, parentPath, name })),
	createFile: (volumeId: string | null, parentPath: string, name: string) => typedError<string, IpcError>(__TAURI_INVOKE("create_file", { volumeId, parentPath, name })),
	/**
	...
	copyFiles: (sources: string[], destination: string, config: {
...
} | null) => typedError<WriteOperationStartResult, WriteOperationError>(__TAURI_INVOKE("copy_files", { sources, destination, config })),
	/**
	 *  Uses rename() for same-filesystem (instant), copy+delete for cross-filesystem.
	 *  Same events as `copy_files`.
	 */
	moveFiles: (sources: string[], destination: string, config: {
	// Progress update interval in milliseconds (default: 200)
	progressIntervalMs?: number,
	// Whether to overwrite existing files (deprecated, use conflict_resolution)
	overwrite?: boolean,
	 ...
	 */
	preKnownConflicts?: string[],
} | null) => typedError<WriteOperationStartResult, WriteOperationError>(__TAURI_INVOKE("move_files", { sources, destination, config })),
	/**
	 ...
	 */
	deleteFiles: (sources: string[], volumeId: string | null, config: {
	// Progress update interval in milliseconds (default: 200)
	progressIntervalMs?: number,
	// Whether to overwrite existing files (deprecated, use conflict_resolution)
	overwrite?: boolean,
	 ...
	 */
	preKnownConflicts?: string[],
} | null) => typedError<WriteOperationStartResult, WriteOperationError>(__TAURI_INVOKE("delete_files", { sources, volumeId, config })),
	// Moves files to macOS Trash. Same events as `copy_files` but with `operationType: trash`.
	trashFiles: (sources: string[], itemSizes: number[] | null, config: {
	// Progress update interval in milliseconds (default: 200)
	progressIntervalMs?: number,
	// Whether to overwrite existing files (deprecated, use conflict_resolution)
	overwrite?: boolean,
	 ...
	 */
	preKnownConflicts?: string[],
} | null) => typedError<WriteOperationStartResult, WriteOperationError>(__TAURI_INVOKE("trash_files", { sources, itemSizes, config })),
	cancelWriteOperation: (operationId: string, rollback: boolean) => __TAURI_INVOKE<void>("cancel_write_operation", { operationId, rollback }),
	 ...
	 */
	startScanPreview: (sources: string[], sourceVolumeId: string | null, sortColumn: SortColumn, sortOrder: SortOrder, progressIntervalMs: number | null) => __TAURI_INVOKE<ScanPreviewStartResult>("start_scan_preview", { sources, sourceVolumeId, sortColumn, sortOrder, progressIntervalMs }),
	 ...
	 */
	checkScanPreviewStatus: (previewId: string) => __TAURI_INVOKE<{
	filesTotal: number,
	dirsTotal: number,
	bytesTotal: number,
	/**
	...
	resolveWriteConflict: (operationId: string, resolution: ConflictResolution, applyToAll: boolean) => __TAURI_INVOKE<void>("resolve_write_conflict", { operationId, resolution, applyToAll }),
	listActiveOperations: () => __TAURI_INVOKE<OperationSummary[]>("list_active_operations"),
	getOperationStatus: (operationId: string) => __TAURI_INVOKE<{
	operationId: string,
	...
	copyBetweenVolumes: (sourceVolumeId: string, sourcePaths: string[], destVolumeId: string, destPath: string, config: {
	// In milliseconds.
	progressIntervalMs: number,
	conflictResolution: ConflictResolution,
	 ...
	 */
	preKnownConflicts?: string[],
} | null) => typedError<WriteOperationStartResult, WriteOperationError>(__TAURI_INVOKE("copy_between_volumes", { sourceVolumeId, sourcePaths, destVolumeId, destPath, config })),
	/**
	 ...
	 *  (copy+delete).
	 */
	moveBetweenVolumes: (sourceVolumeId: string, sourcePaths: string[], destVolumeId: string, destPath: string, config: {
	// In milliseconds.
	progressIntervalMs: number,
	conflictResolution: ConflictResolution,
	// Maximum returned in pre-flight scan.
	 ...
	 */
	preKnownConflicts?: string[],
} | null) => typedError<WriteOperationStartResult, WriteOperationError>(__TAURI_INVOKE("move_between_volumes", { sourceVolumeId, sourcePaths, destVolumeId, destPath, config })),
	// Pre-flight scan: total count/bytes, available space, conflicts. Doesn't copy anything.
	scanVolumeForCopy: (sourceVolumeId: string, sourcePaths: string[], destVolumeId: string, destPath: string, maxConflicts: number | null) => typedError<VolumeCopyScanResult, IpcError>(__TAURI_INVOKE("scan_volume_for_copy", { sourceVolumeId, sourcePaths, destVolumeId, destPath, maxConflicts })),
	/**
	 ...
	 */
	scanVolumeForConflicts: (volumeId: string, sourceItems: SourceItemInput[], destPath: string, sourceVolumeId: string | null, sourcePaths: string[] | null) => typedError<ScanConflict[], IpcError>(__TAURI_INVOKE("scan_volume_for_conflicts", { volumeId, sourceItems, destPath, sourceVolumeId, sourcePaths })),
	// Returns total file/dir counts and sizes, plus selection stats if `selected_indices` is given.
	getListingStats: (listingId: string, includeHidden: boolean, selectedIndices: number[] | null) => typedError<ListingStats, string>(__TAURI_INVOKE("get_listing_stats", { listingId, includeHidden, selectedIndices })),
	// Re-enriches cached listing entries with fresh drive index data.
	refreshListingIndexSizes: (listingId: string) => typedError<null, string>(__TAURI_INVOKE("refresh_listing_index_sizes", { listingId })),
	// Initiates native drag from Rust directly, looking up paths from `LISTING_CACHE` (macOS only).
	startSelectionDrag: (listingId: string, selectedIndices: number[], includeHidden: boolean, hasParent: boolean, iconPath: string) => typedError<null, string>(__TAURI_INVOKE("start_selection_drag", { listingId, selectedIndices, includeHidden, hasParent, iconPath })),
	/**
	 ...
	 */
	startDragPaths: (paths: string[], iconPath: string, sourceVolumeId: string | null) => typedError<null, string>(__TAURI_INVOKE("start_drag_paths", { paths, iconPath, sourceVolumeId })),
	/**
	 ...
	 */
	prepareSelfDragOverlay: (richImagePath: string) => __TAURI_INVOKE<void>("prepare_self_drag_overlay", { richImagePath }),
	 ...
	 */
	subscribeGitState: (repoRoot: string) => typedError<RepoInfo, IpcError>(__TAURI_INVOKE("subscribe_git_state", { repoRoot })),
	/**
	 ...
	 */
	getGitStatusForPaths: (repoRoot: string, dir: string) => __TAURI_INVOKE<TimedOut<EntryStatus[]>>("get_git_status_for_paths", { repoRoot, dir }),
	/**
	 *  Checks if a file/folder can be renamed (parent writable, not immutable, not SIP-protected, not
	 *  locked).
	 */
	checkRenamePermission: (path: string) => typedError<null, IpcError>(__TAURI_INVOKE("check_rename_permission", { path })),
	/**
	 ...
	 */
	checkRenameValidity: (dir: string, oldName: string, newName: string, volumeId: string | null) => typedError<RenameValidityResult, IpcError>(__TAURI_INVOKE("check_rename_validity", { dir, oldName, newName, volumeId })),
	/**
	 ...
	 */
	renameFile: (from: string, to: string, force: boolean, volumeId: string | null) => typedError<null, IpcError>(__TAURI_INVOKE("rename_file", { from, to, force, volumeId })),
	 ...
	 */
	getChildWindowRect: (label: string) => __TAURI_INVOKE<{
	x: number,
	y: number,
	width: number,
	height: number,
	 ...
	 */
	setChildWindowRect: (label: string, rect: ChildWindowRect) => __TAURI_INVOKE<void>("set_child_window_rect", { label, rect }),
	/**
	 ...
	 */
	viewerOpen: (path: string, windowLabel: string) => typedError<ViewerOpenResult, IpcError>(__TAURI_INVOKE("viewer_open", { path, windowLabel })),
	/**
	 ...
	 */
	viewerOpenAsText: (path: string, windowLabel: string) => typedError<ViewerOpenResult, IpcError>(__TAURI_INVOKE("viewer_open_as_text", { path, windowLabel })),
	/**
	 ...
	 */
	viewerGetLines: (sessionId: string, targetType: string, targetValue: number, count: number) => typedError<LineChunk, IpcError>(__TAURI_INVOKE("viewer_get_lines", { sessionId, targetType, targetValue, count })),
	// Gets the current status of a viewer session (backend type, indexing state).
	viewerGetStatus: (sessionId: string) => typedError<ViewerSessionStatus, string>(__TAURI_INVOKE("viewer_get_status", { sessionId })),
	/**
	 ...
	 *  typed message.
	 */
	viewerSearchStart: (sessionId: string, query: string, mode: SearchMode) => typedError<null, string>(__TAURI_INVOKE("viewer_search_start", { sessionId, query, mode })),
	// Polls search progress and new matches since `since_index`.
	viewerSearchPoll: (sessionId: string, sinceIndex: number) => typedError<SearchPollResult, string>(__TAURI_INVOKE("viewer_search_poll", { sessionId, sinceIndex })),
	// Cancels an ongoing search.
	viewerSearchCancel: (sessionId: string) => typedError<null, string>(__TAURI_INVOKE("viewer_search_cancel", { sessionId })),
	 ...
	 */
	viewerReadRange: (sessionId: string, readId: number, anchor: RangeEnd, focus: RangeEnd) => typedError<string, ViewerError>(__TAURI_INVOKE("viewer_read_range", { sessionId, readId, anchor, focus })),
	/**
	 ...
	 */
	viewerCancelRead: (sessionId: string, readId: number) => typedError<null, ViewerError>(__TAURI_INVOKE("viewer_cancel_read", { sessionId, readId })),
	/**
	 ...
	 */
	viewerWriteRangeToFile: (sessionId: string, readId: number, anchor: RangeEnd, focus: RangeEnd, destPath: string) => typedError<null, ViewerError>(__TAURI_INVOKE("viewer_write_range_to_file", { sessionId, readId, anchor, focus, destPath })),
	/**
	 ...
	 */
	viewerSetWordWrap: (label: string, checked: boolean) => typedError<null, string>(__TAURI_INVOKE("viewer_set_word_wrap", { label, checked })),
	/**
	 ...
	 */
	viewerGetEncodingOptions: (sessionId: string) => typedError<EncodingOptions, string>(__TAURI_INVOKE("viewer_get_encoding_options", { sessionId })),
	/**
	 ...
	 */
	viewerSetEncoding: (sessionId: string, encoding: FileEncoding) => typedError<null, string>(__TAURI_INVOKE("viewer_set_encoding", { sessionId, encoding })),
	/**
	 ...
	 */
	viewerSetTailMode: (sessionId: string, enabled: boolean) => typedError<null, string>(__TAURI_INVOKE("viewer_set_tail_mode", { sessionId, enabled })),
	/**
	 ...
	 *  the gate clears.
	 */
	getIcons: (iconIds: string[], useAppIconsForDocuments: boolean) => __TAURI_INVOKE<TimedOut<{ [key in string]: string }>>("get_icons", { iconIds, useAppIconsForDocuments }),
	/**
	 ...
	 */
	getCustomFolderIconIds: (directoryPaths: string[]) => __TAURI_INVOKE<TimedOut<string[]>>("get_custom_folder_icon_ids", { directoryPaths }),
	/**
	 ...
	 */
	refreshDirectoryIcons: (directoryPaths: string[], extensions: string[], useAppIconsForDocuments: boolean) => __TAURI_INVOKE<TimedOut<{ [key in string]: string }>>("refresh_directory_icons", { directoryPaths, extensions, useAppIconsForDocuments }),
	/**
	 ...
	 *  times out.
	 */
	showTabContextMenu: (isPinned: boolean, canClose: boolean, hasOtherUnpinnedTabs: boolean) => typedError<null, string>(__TAURI_INVOKE("show_tab_context_menu", { isPinned, canClose, hasOtherUnpinnedTabs })),
	/**
	 ...
	 *  from `on_menu_event`.
	 */
	showNetworkHostContextMenu: (hostId: string, hostName: string, isManual: boolean, hasCredentials: boolean) => typedError<null, string>(__TAURI_INVOKE("show_network_host_context_menu", { hostId, hostName, isManual, hasCredentials })),
	...
	quickLookOpen: (path: string, volumeId: string) => typedError<null, string>(__TAURI_INVOKE("quick_look_open", { path, volumeId })),
	quickLookSetPath: (path: string, volumeId: string) => typedError<null, string>(__TAURI_INVOKE("quick_look_set_path", { path, volumeId })),
	 ...
	 *  OneDrive, Box, etc.).
	 */
	cloudMakeAvailableOffline: (path: string) => typedError<null, string>(__TAURI_INVOKE("cloud_make_available_offline", { path })),
	/**
	 ...
	 */
	getSyncStatus: (paths: string[]) => __TAURI_INVOKE<TimedOut<{ [key in string]: SyncStatus }>>("get_sync_status", { paths }),
	/**
	 ...
	 */
	getSmbDiagnostics: (volumeId: string) => typedError<SmbDiagnosticsDto, string>(__TAURI_INVOKE("get_smb_diagnostics", { volumeId })),
	/**
	...
	watchVolumeSpace: (watcherId: string, volumeId: string, path: string) => __TAURI_INVOKE<void>("watch_volume_space", { watcherId, volumeId, path }),
	...
	setLowDiskSpaceConfig: (enabled: boolean, thresholdPercent: number) => __TAURI_INVOKE<void>("set_low_disk_space_config", { enabled, thresholdPercent }),
	/**
	 ...
	 */
	checkPendingCrashReport: () => __TAURI_INVOKE<{
	version: number,
	timestamp: string,
	signal: string | null,
	 ...
	 */
	sendErrorReport: (userNote: string | null, email: string | null) => typedError<SendResult, string>(__TAURI_INVOKE("send_error_report", { userNote, email })),
	/**
	 ...
	 */
	recordSettingsDefaults: (defaults: { [key in string]: SettingValue }) => __TAURI_INVOKE<void>("record_settings_defaults", { defaults }),
	/**
	 ...
	 */
	sendFeedback: (feedbackText: string, email: string | null) => __TAURI_INVOKE<SendFeedbackResult>("send_feedback", { feedbackText, email }),
	 ...
	 */
	activateLicense: (licenseKey: string) => typedError<LicenseInfo, LicenseActivationError>(__TAURI_INVOKE("activate_license", { licenseKey })),
	/**
	 ...
	 */
	verifyLicense: (licenseKey: string) => typedError<VerifyResult, LicenseActivationError>(__TAURI_INVOKE("verify_license", { licenseKey })),
	/**
	 *  Persist a verified license key to disk and update caches.
	 *  Only call after verification confirms the key is valid.
	 */
	commitLicense: (licenseKey: string, shortCode: string | null) => typedError<LicenseInfo, LicenseActivationError>(__TAURI_INVOKE("commit_license", { licenseKey, shortCode })),
	// Get information about the current license (if any).
	getLicenseInfo: () => __TAURI_INVOKE<{
	email: string,
	 ...
	 */
	validateLicenseWithServer: (transactionId: string | null) => typedError<AppStatus, string>(__TAURI_INVOKE("validate_license_with_server", { transactionId })),
	 ...
	 */
	checkAiConnection: (baseUrl: string, apiKey: string) => __TAURI_INVOKE<AiConnectionCheckResult>("check_ai_connection", { baseUrl, apiKey }),
	/**
	...
	saveAiApiKey: (providerId: string, apiKey: string) => typedError<null, AiApiKeyError>(__TAURI_INVOKE("save_ai_api_key", { providerId, apiKey })),
	/**
	 ...
	 */
	getAiApiKey: (providerId: string) => typedError<string, AiApiKeyError>(__TAURI_INVOKE("get_ai_api_key", { providerId })),
	deleteAiApiKey: (providerId: string) => typedError<null, AiApiKeyError>(__TAURI_INVOKE("delete_ai_api_key", { providerId })),
	 ...
	 */
	getFolderSuggestions: (listingId: string, currentPath: string, includeHidden: boolean) => typedError<string[], string>(__TAURI_INVOKE("get_folder_suggestions", { listingId, currentPath, includeHidden })),
	 ...
	 */
	updateFileWatcherDebounce: (debounceMs: number) => __TAURI_INVOKE<void>("update_file_watcher_debounce", { debounceMs }),
	/**
	 ...
	 */
	updateServiceResolveTimeout: (timeoutMs: number) => __TAURI_INVOKE<void>("update_service_resolve_timeout", { timeoutMs }),
	/**
	 *  Update menu accelerator for a command.
	 *  Called from frontend when keyboard shortcuts are changed.
	 */
	updateMenuAccelerator: (commandId: string, shortcut: string) => typedError<null, string>(__TAURI_INVOKE("update_menu_accelerator", { commandId, shortcut })),
	/**
	 ...
	 */
	setFilterSafeSaveArtifactsCmd: (enabled: boolean) => __TAURI_INVOKE<void>("set_filter_safe_save_artifacts_cmd", { enabled }),
	/**
	 ...
	 */
	persistRestrictedWindowSetting: (setting: RestrictedWindowPersistableSetting, value: boolean) => typedError<null, string>(__TAURI_INVOKE("persist_restricted_window_setting", { setting, value })),
	/**
	 ...
	 */
	recheckDownloadsWatcherGate: () => typedError<null, WatcherGateError>(__TAURI_INVOKE("recheck_downloads_watcher_gate")),
	/**
	 ...
	 */
	setGlobalGoToLatestShortcut: (enabled: boolean, binding: string) => typedError<GlobalGoToLatestShortcutState, RegistrationError>(__TAURI_INVOKE("set_global_go_to_latest_shortcut", { enabled, binding })),
	...
	getDirStats: (path: string) => typedError<{
	path: string,
...
} | null, string>(__TAURI_INVOKE("get_dir_stats", { path })),
	getDirStatsBatch: (paths: string[]) => typedError<(DirStats | null)[], string>(__TAURI_INVOKE("get_dir_stats_batch", { paths })),
	...
	setIndexingEnabled: (enabled: boolean) => typedError<null, string>(__TAURI_INVOKE("set_indexing_enabled", { enabled })),
	/**
	 ...
	 */
	getVolumeIndexStatus: (path: string) => typedError<VolumeIndexStatus, string>(__TAURI_INVOKE("get_volume_index_status", { path })),
	/**
	 ...
	 */
	translateSearchQuery: (naturalQuery: string, currentType: boolean | null) => typedError<TranslateResult, AiTranslateError>(__TAURI_INVOKE("translate_search_query", { naturalQuery, currentType })),
	 ...
	 */
	addRecentSearch: (entry: HistoryEntry, maxCount: number | null) => typedError<null, string>(__TAURI_INVOKE("add_recent_search", { entry, maxCount })),
	 ...
	 */
	applyRecentSearchesMaxCount: (maxCount: number) => typedError<null, string>(__TAURI_INVOKE("apply_recent_searches_max_count", { maxCount })),
	/**
	 ...
	 */
	resolveGoToPath: (input: string, baseDir: string) => typedError<GoToPathResolution, IpcError>(__TAURI_INVOKE("resolve_go_to_path", { input, baseDir })),
	 ...
	 */
	addFavorite: (path: string, name: string | null) => typedError<null, IpcError>(__TAURI_INVOKE("add_favorite", { path, name })),
	...
	renameFavorite: (id: string, name: string) => typedError<null, IpcError>(__TAURI_INVOKE("rename_favorite", { id, name })),
	/**
	 ...
	 */
	reorderFavorites: (orderedIds: string[]) => typedError<null, IpcError>(__TAURI_INVOKE("reorder_favorites", { orderedIds })),
	/**
	 ...
	 */
	getWhatsNew: (sinceVersion: string | null, max: number) => __TAURI_INVOKE<WhatsNewRelease[]>("get_whats_new", { sinceVersion, max }),
	/**
	 ...
	 */
	translateSelectionQuery: (prompt: string, sampleNames: string[], currentType: boolean | null) => typedError<SelectionTranslateResult, AiTranslateError>(__TAURI_INVOKE("translate_selection_query", { prompt, sampleNames, currentType })),
	/**
	 *  Returns the persisted recent-selections entries (newest first). `limit = None`
	 *  returns all.
	 */
	getRecentSelections: (limit: number | null) => __TAURI_INVOKE<SelectionHistoryEntry[]>("get_recent_selections", { limit }),
	/**
	 ...
	 */
	addRecentSelection: (entry: SelectionHistoryEntry, maxCount: number | null) => typedError<null, string>(__TAURI_INVOKE("add_recent_selection", { entry, maxCount })),
	 ...
	 */
	applyRecentSelectionsMaxCount: (maxCount: number) => typedError<null, string>(__TAURI_INVOKE("apply_recent_selections_max_count", { maxCount })),
	/**
	 ...
	 */
	copyFilesToClipboard: (listingId: string, selectedIndices: number[], cursorIndex: number, hasParent: boolean, includeHidden: boolean) => typedError<number, string>(__TAURI_INVOKE("copy_files_to_clipboard", { listingId, selectedIndices, cursorIndex, hasParent, includeHidden })),
	/**
	 ...
	 */
	cutFilesToClipboard: (listingId: string, selectedIndices: number[], cursorIndex: number, hasParent: boolean, includeHidden: boolean) => typedError<number, string>(__TAURI_INVOKE("cut_files_to_clipboard", { listingId, selectedIndices, cursorIndex, hasParent, includeHidden })),
	/**
	 ...
	 */
	copyPathsToClipboard: (paths: string[]) => typedError<number, string>(__TAURI_INVOKE("copy_paths_to_clipboard", { paths })),
	/**
	 ...
	 */
	cutPathsToClipboard: (paths: string[]) => typedError<number, string>(__TAURI_INVOKE("cut_paths_to_clipboard", { paths })),
	/**
	 ...
	 */
	connectMtpDevice: (deviceId: string) => typedError<ConnectedDeviceInfo, MtpConnectionError>(__TAURI_INVOKE("connect_mtp_device", { deviceId })),
	/**
	 ...
	 */
	getMtpDeviceInfo: (deviceId: string) => __TAURI_INVOKE<{
	// Device information.
	 ...
	 */
	disconnectMtpDevice: (deviceId: string) => typedError<null, MtpConnectionError>(__TAURI_INVOKE("disconnect_mtp_device", { deviceId })),
	/**
	 ...
	 */
	listMtpDirectory: (deviceId: string, storageId: number, path: string) => typedError<FileEntry[], MtpConnectionError>(__TAURI_INVOKE("list_mtp_directory", { deviceId, storageId, path })),
	/**
	 ...
	 */
	downloadMtpFile: (deviceId: string, storageId: number, objectPath: string, localDest: string, operationId: string) => typedError<MtpOperationResult, MtpConnectionError>(__TAURI_INVOKE("download_mtp_file", { deviceId, storageId, objectPath, localDest, operationId })),
	/**
	 ...
	 *  * `operation_id` - Unique operation ID for progress tracking
	 */
	uploadToMtp: (deviceId: string, storageId: number, localPath: string, destFolder: string, operationId: string) => typedError<MtpObjectInfo, MtpConnectionError>(__TAURI_INVOKE("upload_to_mtp", { deviceId, storageId, localPath, destFolder, operationId })),
	/**
	 ...
	 */
	deleteMtpObject: (deviceId: string, storageId: number, objectPath: string) => typedError<null, MtpConnectionError>(__TAURI_INVOKE("delete_mtp_object", { deviceId, storageId, objectPath })),
	/**
	 ...
	 */
	createMtpFolder: (deviceId: string, storageId: number, parentPath: string, folderName: string) => typedError<MtpObjectInfo, MtpConnectionError>(__TAURI_INVOKE("create_mtp_folder", { deviceId, storageId, parentPath, folderName })),
	/**
	 ...
	 */
	renameMtpObject: (deviceId: string, storageId: number, objectPath: string, newName: string) => typedError<MtpObjectInfo, MtpConnectionError>(__TAURI_INVOKE("rename_mtp_object", { deviceId, storageId, objectPath, newName })),
	/**
	 ...
	 */
	moveMtpObject: (deviceId: string, storageId: number, objectPath: string, newParentPath: string) => typedError<MtpObjectInfo, MtpConnectionError>(__TAURI_INVOKE("move_mtp_object", { deviceId, storageId, objectPath, newParentPath })),
	/**
	 ...
	 */
	scanMtpForCopy: (deviceId: string, storageId: number, path: string) => typedError<MtpScanResult, MtpConnectionError>(__TAURI_INVOKE("scan_mtp_for_copy", { deviceId, storageId, path })),
	/**
	 ...
	 */
	resolveHost: (hostId: string) => __TAURI_INVOKE<{
	...
	connectToServer: (address: string) => typedError<ManualConnectResult, string>(__TAURI_INVOKE("connect_to_server", { address })),
	 ...
	 */
	listSharesOnHost: (hostId: string, hostname: string, ipAddress: string | null, port: number, timeoutMs: number | null, cacheTtlMs: number | null) => typedError<ShareListResult, ShareListError>(__TAURI_INVOKE("list_shares_on_host", { hostId, hostname, ipAddress, port, timeoutMs, cacheTtlMs })),
	/**
	 ...
	 */
	prefetchShares: (hostId: string, hostname: string, ipAddress: string | null, port: number, timeoutMs: number | null, cacheTtlMs: number | null) => __TAURI_INVOKE<void>("prefetch_shares", { hostId, hostname, ipAddress, port, timeoutMs, cacheTtlMs }),
	...
	getKnownShareByName: (serverName: string, shareName: string) => __TAURI_INVOKE<{
	serverName: string,
	shareName: string,
	// Currently only "smb".
	protocol: string,
	...
	updateKnownShare: (serverName: string, shareName: string, lastConnectionMode: ConnectionMode, lastKnownAuthOptions: AuthOptions, username: string | null) => __TAURI_INVOKE<void>("update_known_share", { serverName, shareName, lastConnectionMode, lastKnownAuthOptions, username }),
	 ...
	 */
	saveSmbCredentials: (server: string, share: string | null, username: string, password: string) => typedError<null, KeychainError>(__TAURI_INVOKE("save_smb_credentials", { server, share, username, password })),
	/**
	 *  Retrieves SMB credentials from the Keychain.
	 *  Returns the stored username and password if found.
	 */
	getSmbCredentials: (server: string, share: string | null) => typedError<SmbCredentials, KeychainError>(__TAURI_INVOKE("get_smb_credentials", { server, share })),
	// Checks if credentials exist in the Keychain for a server/share.
	hasSmbCredentials: (server: string, share: string | null) => __TAURI_INVOKE<boolean>("has_smb_credentials", { server, share }),
	// Deletes SMB credentials from the Keychain.
	deleteSmbCredentials: (server: string, share: string | null) => typedError<null, KeychainError>(__TAURI_INVOKE("delete_smb_credentials", { server, share })),
	/**
	 ...
	 *  * `cache_ttl_ms` - Optional cache TTL in milliseconds (default: 30000)
	 */
	listSharesWithCredentials: (hostId: string, hostname: string, ipAddress: string | null, port: number, username: string | null, password: string | null, timeoutMs: number | null, cacheTtlMs: number | null) => typedError<ShareListResult, ShareListError>(__TAURI_INVOKE("list_shares_with_credentials", { hostId, hostname, ipAddress, port, username, password, timeoutMs, cacheTtlMs })),
	/**
	 ...
	 */
	mountNetworkShare: (server: string, share: string, username: string | null, password: string | null, port: number | null, timeoutMs: number | null) => typedError<MountResult, MountError>(__TAURI_INVOKE("mount_network_share", { server, share, username, password, port, timeoutMs })),
	/**
	 ...
	 */
	upgradeToSmbVolume: (volumeId: string) => typedError<UpgradeResult, string>(__TAURI_INVOKE("upgrade_to_smb_volume", { volumeId })),
	/**
	 ...
	 */
	setSmbIndexingEnabled: (volumeId: string, enabled: boolean) => typedError<null, SmbIndexGateReason>(__TAURI_INVOKE("set_smb_indexing_enabled", { volumeId, enabled })),
	/**
	 ...
	 */
	upgradeToSmbVolumeWithCredentials: (volumeId: string, username: string | null, password: string | null, rememberInKeychain: boolean) => typedError<UpgradeResult, string>(__TAURI_INVOKE("upgrade_to_smb_volume_with_credentials", { volumeId, username, password, rememberInKeychain })),
	/**
	 ...
	 */
	systemHasSavedSmbPassword: (volumeId: string) => typedError<boolean, string>(__TAURI_INVOKE("system_has_saved_smb_password", { volumeId })),
	/**
	 ...
	 */
	upgradeToSmbVolumeUsingSavedPassword: (volumeId: string) => typedError<UpgradeResult, string>(__TAURI_INVOKE("upgrade_to_smb_volume_using_saved_password", { volumeId })),
	/**
	 ...
	 */
	reconnectSmbVolume: (volumeId: string) => typedError<null, IpcError>(__TAURI_INVOKE("reconnect_smb_volume", { volumeId })),
	/**
	 ...
	 */
	reconnectSmbVolumeWithCredentials: (volumeId: string, username: string, password: string) => typedError<null, IpcError>(__TAURI_INVOKE("reconnect_smb_volume_with_credentials", { volumeId, username, password })),
	/**
	 ...
	 */
	disconnectSmbVolume: (volumeId: string) => typedError<null, IpcError>(__TAURI_INVOKE("disconnect_smb_volume", { volumeId })),
	/**
	...
	removeManualServer: (serverId: string) => typedError<null, string>(__TAURI_INVOKE("remove_manual_server", { serverId })),
	/**
	 ...
	 */
	disconnectNetworkHost: (hostId: string, hostName: string, ipAddress: string | null) => typedError<string[], string>(__TAURI_INVOKE("disconnect_network_host", { hostId, hostName, ipAddress })),
	/**
	 ...
	 */
	downloadUpdate: (url: string, signature: string) => typedError<null, string>(__TAURI_INVOKE("download_update", { url, signature })),
	/**
	 ...
	 */
	saveErrorReportToDisk: (userNote: string | null, email: string | null) => typedError<string, string>(__TAURI_INVOKE("save_error_report_to_disk", { userNote, email })),
	/**
	 ...
	 */
	previewFriendlyError: (errorCode: number | null, variant: string | null, providerPath: string | null) => typedError<ListingError, string>(__TAURI_INVOKE("preview_friendly_error", { errorCode, variant, providerPath })),
};
...
export type AiApiKeyError = { type: "not_found"; message: string } | { type: "access_denied"; message: string } | { type: "other"; message: string };
...
export type AiStatus = "unavailable" | 
...
export type AuthMode = "guest_allowed" | "creds_required" | 
...
export type DiscoveryState = "idle" | "searching" | 
 ...
 */
export type FileEncoding = "utf8" | "utf8WithBom" | "windows1252" | "iso8859_1" | "macRoman" | "usAscii" | "utf16Le" | "utf16Be";
 ...
 */
export type ListingErrorReason = { reason: "interrupted" } | { reason: "notEnoughMemory" } | { reason: "resourceBusy"; path: string } | { reason: "temporarilyUnavailable" } | { reason: "networkDown" } | { reason: "networkConnectionDropped" } | { reason: "connectionDropped" } | { reason: "connectionReset" } | { reason: "connectionTimedOutErrno" } | { reason: "hostDown" } | { reason: "staleConnection" } | { reason: "lockUnavailable" } | { reason: "cancelledErrno" } | { reason: "notPermitted"; path: string } | { reason: "pathNotFoundErrno"; path: string } | { reason: "noPermissionErrno"; path: string } | { reason: "alreadyExistsErrno"; path: string } | { reason: "crossDeviceOperation" } | { reason: "notAFolder"; path: string } | { reason: "isAFolderErrno"; path: string } | { reason: "diskFullErrno" } | { reason: "readOnlyVolumeErrno" } | { reason: "notSupportedErrno" } | { reason: "networkUnreachable" } | { reason: "connectionRefused" } | { reason: "symlinkLoopErrno"; path: string } | { reason: "nameTooLongErrno" } | { reason: "hostUnreachable" } | { reason: "folderNotEmpty"; path: string } | { reason: "quotaExceeded" } | { reason: "authRequiredEauth" } | { reason: "authRequiredEneedauth" } | { reason: "devicePoweredOff" } | { reason: "attributeNotFound" } | { reason: "diskReadProblem"; path: string } | { reason: "unexpectedSystemResponse" } | { reason: "deviceProblem" } | { reason: "couldntReadUnknown"; path: string } | { reason: "notFound"; path: string } | { reason: "tccRestricted"; path: string } | { reason: "permissionDenied"; path: string } | { reason: "alreadyExists"; path: string } | { reason: "cancelled" } | { reason: "deviceDisconnected"; path: string } | { reason: "readOnly" } | { reason: "storageFull" } | { reason: "connectionTimedOut" } | { reason: "notSupported" } | { reason: "deletePending"; path: string } | { reason: "ioSerious"; path: string; osMessage: string } | { reason: "isADirectory"; path: string } | { reason: "emptyRootICloud" } | { reason: "git"; kind: FriendlyGitErrorKind };
...
export type ListingStatus = { status: "loading" } | { status: "ready" } | { status: "cancelled" } | { status: "error"; message: string };
...
export type LocationCategory = "favorite" | "main_volume" | "attached_volume" | "cloud_drive" | "network" | "mobile_device";
...
export type MountError = { type: "host_unreachable"; message: string } | { type: "share_not_found"; message: string } | { type: "auth_required"; message: string } | { type: "auth_failed"; message: string } | { type: "permission_denied"; message: string } | { type: "timeout"; message: string } | { type: "cancelled"; message: string } | { type: "protocol_error"; message: string } | 
...
export type MtpConnectionError = { type: "deviceNotFound"; device_id: string } | { type: "notConnected"; device_id: string } | { type: "exclusiveAccess"; device_id: string; blocking_process: string | null } | { type: "timeout"; device_id: string } | { type: "disconnected"; device_id: string } | { type: "protocol"; device_id: string; message: string } | 
// Retryable.
{ type: "deviceBusy"; device_id: string } | { type: "storageFull"; device_id: string } | { type: "storeReadOnly"; device_id: string } | 
// Linux: USB device file not accessible (missing udev rules).
{ type: "permissionDenied"; device_id: string } | { type: "cancelled"; device_id: string; message: string } | { type: "objectNotFound"; device_id: string; path: string } | 
/**
 ...
 */
{ type: "staleParentHandle"; device_id: string; dest_folder: string } | { type: "other"; device_id: string; message: string };
 ...
 */
export type Provider = "dropbox" | "googleDrive" | "oneDrive" | "box" | "pCloud" | "nextcloud" | "synologyDrive" | "tresorit" | "protonDrive" | "sync" | "egnyte" | "macDroid" | "iCloud" | "pCloudFuse" | "macFuse" | "veraCrypt" | "cmVolumes" | 
 ...
 */
export type SearchStatus = { status: "running" } | { status: "done" } | { status: "cancelled" } | { status: "idle" } | { status: "invalidQuery"; message: string };
 ...
 */
export type ShareListError = { type: "host_unreachable"; message: string } | { type: "timeout"; message: string } | { type: "auth_required"; message: string } | 
// Guest access won't work.
{ type: "signing_required"; message: string } | { type: "auth_failed"; message: string } | { type: "protocol_error"; message: string } | { type: "resolution_failed"; message: string } | 
...
"online_only" | "uploading" | "downloading" | 
...
{ status: "credentialsNeeded"; server: string; share: string; port: number; 
 ...
 */
export type ViewerError = { kind: "io"; message: string } | { kind: "notFound"; path: string } | { kind: "isDirectory" } | { kind: "sessionNotFound"; sessionId: string } | 
...
export type WriteOperationError = { type: "source_not_found"; path: string } | 
// Overwrite not enabled.
{ type: "destination_exists"; path: string } | { type: "permission_denied"; path: string; message: string } | { type: "insufficient_space"; required: number; available: number; volumeName: string | null } | { type: "same_location"; path: string } | 
// Would cause infinite recursion.
{ type: "destination_inside_source"; source: string; destination: string } | { type: "symlink_loop"; path: string } | { type: "cancelled"; message: string } | 
