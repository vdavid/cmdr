// AUTO-GENERATED — do not edit. Regenerate with `cargo nextest run export_bindings_test`.
...
"alwaysByName" | null, listingId: string) => typedError<StreamingListingStartResult, string>(__TAURI_INVOKE("list_directory_start_streaming", { volumeId, path, includeHidden, sortBy, sortOrder, directorySortMode, listingId })),
	...
	getMaxFilenameWidth: (listingId: string, includeHidden: boolean) => typedError<number | null, string>(__TAURI_INVOKE("get_max_filename_width", { listingId, includeHidden })),
...
"alwaysByName" | null, cursorFilename: string | null, includeHidden: boolean, selectedIndices: number[] | null, allSelected: boolean | null) => typedError<ResortResult, string>(__TAURI_INVOKE("resort_listing", { listingId, sortBy, sortOrder, directorySortMode, cursorFilename, includeHidden, selectedIndices, allSelected })),
	...
	scanVolumeForConflicts: (volumeId: string, sourceItems: SourceItemInput[], destPath: string) => typedError<ScanConflict[], IpcError>(__TAURI_INVOKE("scan_volume_for_conflicts", { volumeId, sourceItems, destPath })),
	 ...
	 */
	startDragPaths: (paths: string[], iconPath: string) => typedError<null, string>(__TAURI_INVOKE("start_drag_paths", { paths, iconPath })),
	/**
	 ...
	 */
	viewerSearchStart: (sessionId: string, query: string) => typedError<null, string>(__TAURI_INVOKE("viewer_search_start", { sessionId, query })),
	 ...
	 */
	sendErrorReport: (userNote: string | null) => typedError<SendResult, string>(__TAURI_INVOKE("send_error_report", { userNote })),
	 ...
	 */
	translateSearchQuery: (naturalQuery: string) => typedError<TranslateResult, string>(__TAURI_INVOKE("translate_search_query", { naturalQuery })),
	 ...
	 */
	saveErrorReportToDisk: (userNote: string | null) => typedError<string, string>(__TAURI_INVOKE("save_error_report_to_disk", { userNote })),
	/**
	 ...
	 */
	previewFriendlyError: (errorCode: number | null, variant: string | null, providerPath: string | null) => typedError<FriendlyError, string>(__TAURI_INVOKE("preview_friendly_error", { errorCode, variant, providerPath })),
};
...
{ type: "permissionDenied"; device_id: string } | { type: "cancelled"; device_id: string; message: string } | { type: "objectNotFound"; device_id: string; path: string } | { type: "other"; device_id: string; message: string };
...
{ type: "destination_exists"; path: string } | { type: "permission_denied"; path: string; message: string } | { type: "insufficient_space"; required: number; available: number; volume_name: string | null } | { type: "same_location"; path: string } | 
