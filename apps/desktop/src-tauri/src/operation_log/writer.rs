...
/// Retention: dropping old operations and reclaiming their space, bounded so it
/// never stops a capture burst. `retention.rs` decides when to ask.
mod prune;
use prune::handle_prune;
