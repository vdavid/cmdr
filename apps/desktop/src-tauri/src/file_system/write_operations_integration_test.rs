...
// ============================================================================
// Conflict resolution mode tests
// ============================================================================
...
#[test]
fn test_conflict_resolution_overwrite_via_flag() {
    let config = WriteOperationConfig {
        overwrite: true,
        ..Default::default()
    };
    // When overwrite is true, it takes precedence
...
fn test_conflict_resolution_serialization() {
    ...
    assert!(json.contains("\"conflictResolution\":\"rename\""));
}
...
#[test]
fn test_write_conflict_event_serialization() {
    let event = WriteConflictEvent {
    ...
    assert!(json.contains("destinationIsNewer"));
    assert!(json.contains("sizeDifference"));
}
...
#[test]
fn test_conflict_skip_mode_config() {
    let config = WriteOperationConfig {
        progress_interval_ms: 200,
        overwrite: false,
...
#[test]
fn test_conflict_overwrite_mode_config() {
    let config = WriteOperationConfig {
        progress_interval_ms: 200,
        overwrite: false,
