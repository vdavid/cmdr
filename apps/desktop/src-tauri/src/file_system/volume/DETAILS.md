...
| `paths_are_os_visible`      | ✅ (inherited)       | ❌ (inherited)          | ✅ OVERRIDE (sneaky mount) | ❌ (inherited)    | ❌ (inherited)           |
