...
**The source-delete phase, and what a directory sweep reports**: `delete_volume_path_recursive` (`cleanup.rs`)
...
The three best-effort callers (rollback, partial cleanup, cross-type Overwrite in `conflict.rs`, and
...
(delete phase), and `copy_tests.rs::delete_volume_path_recursive_reports_the_leaf_that_refused` (the walker
