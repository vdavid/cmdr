//! What a running copy reports: every file arriving, the progress events'
//! running totals, intra-file byte progress on both drivers, leaf-granular
//! progress through a directory source, and reaching `files_done == n`.
