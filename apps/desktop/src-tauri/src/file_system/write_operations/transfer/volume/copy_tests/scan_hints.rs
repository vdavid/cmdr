//! What the dialog preview hands the copy: the pre-scanned source hint (no
//! rescan before the first conflict prompt) and pre-known conflicts, bulk-skipped
//! up front in Skip mode and ignored everywhere else.
