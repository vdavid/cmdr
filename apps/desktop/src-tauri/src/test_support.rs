...
//! invariant behind the index-walk memory work. The counting allocator that backs it is a
//! `#[global_allocator]`, so it has to live in the binary being tested and can't move to a shared
//! crate.
