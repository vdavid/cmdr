...
pub(crate) fn collect_cross_platform_types(types: &mut Types) -> Vec<Function> {
    ...
    collect_functions![
        ...
        crate::media_index::commands::policy::media_index_set_network_volume_enabled,
        crate::media_index::commands::policy::media_index_set_always_index_volume,
        crate::media_index::commands::policy::media_index_set_always_index_folder,
        ...
        crate::media_index::commands::media_index_delete_clip_model,
