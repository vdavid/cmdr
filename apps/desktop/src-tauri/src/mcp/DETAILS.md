...
All 38 tools are authored once in the `mcp_tools!` table in `tool_registry.rs` — name, description, JSON schema,
...
38 semantic tools grouped by category:
