...
/// prompt is 1,636 of it, the 18 tool declarations the rest.
///
...
pub const FIXED_PROMPT_OVERHEAD_TOKENS: usize = 5_793;
...
mod tests {
    ...
    fn a_batch_hint_derives_from_the_budget() {
        // (budget − 10% headroom − 5,793 of prefix) / 349 per file, while the prompt is what
        // binds.
        assert_eq!(files_per_batch(16_000), 24);
        assert_eq!(files_per_batch(32_000), 65);
