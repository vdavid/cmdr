...
/// prompt is 1,371 of it, the 17 tool declarations the rest.
///
...
pub const FIXED_PROMPT_OVERHEAD_TOKENS: usize = 5_340;
...
mod tests {
    ...
    fn a_batch_hint_derives_from_the_budget() {
        // (budget − 10% headroom − 5,340 of prefix) / 349 per file, while the prompt is what
        // binds.
