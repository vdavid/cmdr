...
const TOOL_DECLARATION_TOKENS: usize = 3_706;
...
fn every_call_pays_about_3_500_tokens_of_fixed_overhead() {
    ...
    assert_eq!(tools.len(), 15, "the overhead below is the cost of THESE declarations");
    ...
    assert_near(declarations, TOOL_DECLARATION_TOKENS, "the 15 tool declarations");
