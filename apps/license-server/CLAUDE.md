...
- [ADR 014: Payment provider choice](../../docs/adr/014-payment-provider-paddle.md) — why Paddle
- [ADR 016: License model](../../docs/adr/016-license-model-bsl.md) — BSL license approach
- `apps/desktop/src/lib/licensing/CLAUDE.md` — full frontend licensing feature overview
