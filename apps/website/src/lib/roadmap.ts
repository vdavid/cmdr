    ...
    groups: [
      {
        ...
        milestones: [
          ...
          { date: '(Jan 7)', title: 'Add command palette', description: '⌘P to find your actions fast.', done: true },
          {
            date: '(Jan 9)',
          ...
          { date: '(Jan 13)', title: 'Add MCP server', description: 'AI agents can now use the app.', done: true },
          {
            date: '(Jan 14)',
          ...
          { date: '(Jan 31)', title: 'Wire up Settings', description: 'Every setting applies instantly.', done: true },
        ],
      },
      {
        heading: 'Feb 2026',
        milestones: [
          ...
          { date: '(Feb 25)', title: 'Add tabs', description: 'For easy switching between folders.', done: true },
          {
            date: '(Feb 27)',
    ...
    groups: [
      {
        milestones: [
          ...
          },
          {
            ...
            description: 'Clean up your Downloads folder, with 100% human oversight.',
            done: false,
          },
