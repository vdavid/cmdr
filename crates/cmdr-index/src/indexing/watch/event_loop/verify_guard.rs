...
//!
//! Both decisions are pure and threshold-injected (the `reconcile/reconciler/rescan/route.rs`
...
/// pathological one.
///
/// To revisit it, re-derive the distribution from an existing index with the SQL
/// in `indexing/DETAILS.md` § "How to measure pathological directories" rather
/// than from the two data points that set it.
