...
- This codebase: the typed-events groundwork that makes events name-joinable — the typed-events pattern is in
  `apps/desktop/src/lib/ipc/CLAUDE.md` (design history in git).
