...
Evidence behind the M6 ANN-engine recommendation. Empirical comparison of the two candidate vector-search engines on a
synthetic CLIP-scale corpus, plus the brute-force f16 baseline that shows what ANN buys.
