...
> every search now waits for its one volume's arena (`docs/specs/unindexed-search-plan.md` Decision 4). The measurements
> stand; the mechanism described is gone. Points 2 and 3 still hold.
