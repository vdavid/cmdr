...
| `tauri-plugin-store` (`settings.json`) | Identifier-driven via `BaseDirectory::AppData`. No code override needed; the identifier change in the generated config redirects the file automatically.                                                                                                     | [`lib.rs`](../../apps/desktop/src-tauri/src/lib.rs)                                                                                        |
