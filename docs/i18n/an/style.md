...
Working notes for translating Cmdr into Aragonese. Read `../README.md` for how this fits the translation process, and
the app-wide `docs/style-guide.md` for the English voice these notes carry into Aragonese.
...
tokens. Enforced by `desktop-i18n-dont-translate`; see `apps/desktop/scripts/i18n-catalog-lib.ts`.
...
sourced from the reference pile (`_ignored/i18n/an/`; recipes in `docs/i18n/reference-pile/how-to-mine.md`); never guess
