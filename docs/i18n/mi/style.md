...
Working notes for translating Cmdr into te reo Māori. Read `../README.md` for how this fits the translation process, and
the app-wide `docs/style-guide.md` for the English voice these notes carry into Māori.
...
sourced from the reference pile (`_ignored/i18n/mi/`; recipes in `docs/i18n/reference-pile/how-to-mine.md`); never guess
