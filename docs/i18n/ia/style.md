...
Working notes for translating Cmdr into Interlingua. Read `../README.md` for how this fits the translation process, and
...
sourced from the reference pile (`_ignored/i18n/ia/`; recipes in `docs/i18n/reference-pile/how-to-mine.md`); never guess
