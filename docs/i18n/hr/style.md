...
`apps/desktop/scripts/i18n-catalog-lib.ts`. macOS UI names Cmdr opens into should match what a Croatian macOS shows
("Smeće", "Postavke").
...
sourced from the reference pile (`_ignored/i18n/hr/`; recipes in `docs/i18n/reference-pile/how-to-mine.md`); never guess
