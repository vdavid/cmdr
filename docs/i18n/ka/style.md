...
`apps/desktop/scripts/i18n-catalog-lib.ts`. Latin brand names stay in Latin script inside Georgian text.
...
sourced from the reference pile (`_ignored/i18n/ka/`; recipes in `docs/i18n/reference-pile/how-to-mine.md`); never guess
