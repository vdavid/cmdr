...
Working notes for translating Cmdr into Dzongkha. Read `../README.md` for how this fits the translation process.
...
sourced from the reference pile (`_ignored/i18n/dz/`; recipes in `docs/i18n/reference-pile/how-to-mine.md`); never guess
