...
Working notes for translating Cmdr into Khmer (ខ្មែរ). Read [`README.md`](../README.md) for how this fits the
...
you settle terms, each sourced from the reference pile (`_ignored/i18n/km/`; recipes in `docs/i18n/reference-pile/how-to-mine.md`).
Never guess a term.
