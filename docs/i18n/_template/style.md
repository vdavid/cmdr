...
`glossary.md`) and fill every section before the first translation pass. Read `../README.md` for how this fits the
translation process.
...
terms, each sourced from the reference pile (`_ignored/i18n/<tag>/`; recipes in
