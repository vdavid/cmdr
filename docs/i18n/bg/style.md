...
`apps/desktop/scripts/i18n-catalog-lib.ts`. Latin brand tokens sit inside Cyrillic text; that's normal, keep them Latin.
...
sourced from the reference pile (`_ignored/i18n/bg/`; recipes in `docs/i18n/reference-pile/how-to-mine.md`); never guess
