...
- **Source every term from the reference pile, never guess.** Mine `_ignored/i18n/nds/` for how Apple, Microsoft, and
  GNOME/Xfce render the term and for similar sentences (recipes: `_ignored/i18n/how-to-mine.md`). Cite the source(s) and
