...
Working notes for translating Cmdr into Slovak. Read `../README.md` for how this fits the translation process, and the
app-wide `docs/style-guide.md` for the English voice these notes carry into Slovak.
...
`apps/desktop/scripts/i18n-catalog-lib.ts`. macOS UI names Cmdr opens into should match what a Slovak macOS shows
("Kôš", "Nastavenia").
...
sourced from the reference pile (`_ignored/i18n/sk/`; recipes in `docs/i18n/reference-pile/how-to-mine.md`); never guess
