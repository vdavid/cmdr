...
Working notes for translating Cmdr into Ido. Read `../README.md` for how this fits the translation process, and the
...
sourced from the reference pile (`_ignored/i18n/io/`; recipes in `docs/i18n/reference-pile/how-to-mine.md`); never guess
