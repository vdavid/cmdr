...
| App        | Tech    | Checks                                                                                                                                                                                              |
| ---------- | ------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Desktop    | Rust    | rustfmt, clippy, cargo-audit, cargo-deny, cargo-udeps, jscpd, log-error-macro, error-string-match, tests, integration-tests (Docker SMB), tests-linux (slow)                                        |
